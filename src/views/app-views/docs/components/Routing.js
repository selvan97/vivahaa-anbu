	...
	return (
		<div>
			...
			<p>
				...
				as base routing system. To add a new route in the template, you can follow the steps below.
			</p>
			<div className="mt-4">
				<h4 className="font-weight-bold">Overview</h4>
				<p class="my-1">
					You can find the template's router configuration in <code>src/configs/RoutesConfig.js</code>, there's 2 type of route group as following.
				</p>
				<ul>
					<li>
						<strong>publicRoutes</strong>
						<p class="mt-1">this routes group included all routes that open to all users.</p>
					</li>
					<li>
						<strong>protectedRoutes</strong>
						<p class="mt-1">This routes group included all routes that required authentication.</p>
					</li>
				</ul>
			</div>
			<div className="mt-4">
				<h4 className="font-weight-bold">Adding a new route</h4>
				<p class="mt-1">You can add the following code to any of the routing groups, depending on the authority you wish to. Refer below mentioned code to create a route:</p>
				...
				<SyntaxHighlighter className="hl-code" language="jsx" style={atomDark}>{`export const protectedRoutes = [
	{
        ...
        meta: {
			...
			<div className="mt-4">
				...
				<p>
					You can config your navigation bar in <code>configs/NavigationConfig.js</code>. We grouped up the navigation tree as an array, add object as the code below to the array
					for new menu item.
				</p>
