			...
			<React.Fragment>
				<Row gutter={16} type="flex">
					<Col sm={24} md={24} lg={12}>
						...
						<DemoCard code={CustomTriggerMd}>
							<CustomTrigger />
						</DemoCard>
						<DemoCard code={DisabledOptionMd}>
							<DisabledOption />
						</DemoCard>
						...
						<DemoCard code={FieldsNameMd}>
							<FieldsName />
						</DemoCard>
					</Col>
					<Col sm={24} md={24} lg={12}>
						<DemoCard code={DefaultValueMd}>
							<DefaultValue />
						</DemoCard>
						<DemoCard code={HoverMd}>
							<Hover />
						</DemoCard>
						<DemoCard code={ChangeOnSelectMd}>
							<ChangeOnSelect />
						</DemoCard>
						<DemoCard code={CustomRenderMd}>
							<CustomRender />
						</DemoCard>
						<DemoCard code={LazyMd}>
							<Lazy />
						</DemoCard>
						<DemoCard code={SuffixMd}>
							<Suffix />
						</DemoCard>
					</Col>
				</Row>
