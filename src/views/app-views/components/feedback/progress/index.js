			...
			<React.Fragment>
				<Row gutter={16} type="flex">
					<Col sm={24} md={24} lg={12}>
						<DemoCard code={LineMd}>
							<Line />
						</DemoCard>
						<DemoCard code={LineMiniMd}>
							<LineMini />
						</DemoCard>
						<DemoCard code={CircleDynamicMd}>
							<CircleDynamic />
						</DemoCard>
						<DemoCard code={FormatMd}>
							<Format />
						</DemoCard>
						<DemoCard code={SegmentMd}>
							<Segment />
						</DemoCard>
						<DemoCard code={GradientLineMd}>
							<GradientLine />
						</DemoCard>
					</Col>
					<Col sm={24} md={24} lg={12}>
						<DemoCard code={CircleMd}>
							<Circle />
						</DemoCard>
						<DemoCard code={CircleMiniMd}>
							<CircleMini />
						</DemoCard>
						<DemoCard code={DynamicMd}>
							<Dynamic />
						</DemoCard>
						<DemoCard code={DashboardMd}>
							<Dashboard />
						</DemoCard>
						<DemoCard code={LinecapMd}>
							<Linecap />
						</DemoCard>
						<DemoCard code={StpesMd}>
							<Stpes />
						</DemoCard>
					</Col>
				</Row>
