			...
			>
				<Row gutter={16} type="flex">
					<Col sm={24} md={24} lg={12}>
						...
						<DemoCard code={ClosableMd}>
							<Closable />
						</DemoCard>
						<DemoCard code={IconMd}>
							<Icon />
						</DemoCard>
						<DemoCard code={BannerMd}>
							<DemoFrame height="250px">
								<Banner />
							</DemoFrame>
						</DemoCard>
					</Col>
					<Col sm={24} md={24} lg={12}>
						<DemoCard code={StyleMd}>
							<Style />
						</DemoCard>
						<DemoCard code={DescriptionMd}>
							<Description />
						</DemoCard>
						<DemoCard code={CloseTextMd}>
							<CloseText />
						</DemoCard>
						<DemoCard code={SmoothClosedMd}>
							<SmoothClosed />
						</DemoCard>
						<DemoCard code={ErrorBoundryMd}>
							<ErrorBoundry />
						</DemoCard>
					</Col>
				</Row>
