			...
			<React.Fragment>
				<Row gutter={16} type="flex">
					<Col sm={24} md={24} lg={12}>
						...
						<DemoCard code={DefaultFileListMd}>
							<DefaultFileList />
						</DemoCard>
						<DemoCard code={FileListMd}>
							<FileList />
						</DemoCard>
						<DemoCard code={DirectoryMd}>
							<Directory />
						</DemoCard>
						<DemoCard code={PictureStyleMd}>
							<PictureStyle />
						</DemoCard>
						<DemoCard code={TransformFileMd}>
							<TransformFile />
						</DemoCard>
						<DemoCard code={UploadCustomActionIconMd}>
							<UploadCustomActionIcon />
						</DemoCard>
					</Col>
					<Col sm={24} md={24} lg={12}>
						<DemoCard code={AvatarMd}>
							<Avatar />
						</DemoCard>
						<DemoCard code={PictureCardMd}>
							<PictureCard />
						</DemoCard>
						<DemoCard code={DragMd}>
							<Drag />
						</DemoCard>
						<DemoCard code={UploadManuallyMd}>
							<UploadManually />
						</DemoCard>
						<DemoCard code={PreviewFileMd}>
							<PreviewFile />
						</DemoCard>
						<DemoCard code={UploadWithAliyunOssMd}>
							<UploadWithAliyunOss />
						</DemoCard>
					</Col>
				</Row>
