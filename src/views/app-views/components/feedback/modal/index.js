			...
			<React.Fragment>
				<Row gutter={16} type="flex">
					<Col sm={24} md={24} lg={12}>
						...
						<DemoCard code={FooterMd}>
							<Footer />
						</DemoCard>
						<DemoCard code={LocaleMd}>
							<Locale />
						</DemoCard>
						<DemoCard code={PositionMd}>
							<Position />
						</DemoCard>
						<DemoCard code={ButtonPropsMd}>
							<ButtonProps />
						</DemoCard>
					</Col>
					<Col sm={24} md={24} lg={12}>
						<DemoCard code={AsyncMd}>
							<Async />
						</DemoCard>
						<DemoCard code={ConfirmMd}>
							<Confirm />
						</DemoCard>
						<DemoCard code={InfoMd}>
							<Info />
						</DemoCard>
						<DemoCard code={ManualMd}>
							<Manual />
						</DemoCard>
						<DemoCard code={ConfirmRouterMd}>
							<ConfirmRouter />
						</DemoCard>
					</Col>
				</Row>
