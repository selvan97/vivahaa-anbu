...
const Page = ({ popupPlacement }) => {
	...
	// ==== Cascader ====
	const cascaderFilter = (inputValue, path) => path.some((option) => option.label.toLowerCase().indexOf(inputValue.toLowerCase()) > -1);
		...
		<div className="direction-components">
			<Row>
				<Col span={24}>
					...
					<Cascader suffixIcon={<SearchIcon />} options={cascaderOptions} onChange={onCascaderChange} placeholder="یک مورد انتخاب کنید" placement={popupPlacement} />
					&nbsp;&nbsp;&nbsp;&nbsp; With search:
					<Cascader
					...
					<Row>
						<Col span={12}>
							...
							<div>
								...
								<br />
								<strong>* Note:</strong> Half star not implemented in RTL direction, it will be supported after <a href="https://github.com/react-component/rate">rc-rate</a>{' '}
