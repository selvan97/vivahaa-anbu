...
const utilTree = [
  ...
  },
  {
    ...
    list: [
      ...
      },
      {
        ...
        props:
          "border-bottom-right-radius: 0.625rem; border-bottom-left-radius: 0.625rem;",
      },
      {
        class: "rounded-left",
        props:
          "border-top-left-radius: 0.625rem; border-bottom-left-radius: 0.625rem",
      },
  ...
  },
  {
    ...
    list: [
      ...
      },
      {
        ...
        props: "justify-content: space-around",
      },
  ...
  },
  {
    ...
    list: [
      ...
      {
        class: "clearfix",
        props: '&::after { display: block; clear: both; content: ""; }',
      },
    ],
  },
  {
    ...
    list: [{ class: "img-fluid", props: "max-width: 100%; height: auto" }],
  },
  {
    title: "Opacity",
  ...
  },
  {
    ...
    list: [
      ...
      {
        class: "fixed-top",
        props: "position: fixed; top: 0; right: 0; left: 0; z-index: 1030;",
      },
      {
        class: "fixed-bottom",
        props: "position: fixed; bottom: 0; right: 0; left: 0; z-index: 1030;",
      },
      {
        class: "sticky-top",
        props: "position: sticky; top: 0; z-index: 1030;",
      },
    ],
  },
  {
    ...
    list: [
      {
        class: "shadow-sm",
        props: "box-shadow: 0 0.125rem 0.25rem rgba(#000000, 0.075)",
      },
      {
        class: "shadow",
        props: "box-shadow: 0 0.5rem 1rem rgba(#000000, 0.15)",
      },
      {
        class: "shadow-lg",
        props: "box-shadow: 0 1rem 3rem rgba(#000000, 0.175)",
      },
  ...
  },
  {
    ...
    list: [
      ...
      {
        class: "text-break",
        props: "word-break: break-word: overflow-wrap: break-word",
      },
    ...
    <div>
      <Row>
        <Col xs={24} sm={24} md={26} lg={18}>
          ...
          <p>
            Vivahaa Matrimony comes with utility css class inspired by
            bootstrap, which help you style your element quickly & handy.
          </p>
          {utilTree.map((elm) => (
