...
export class MenuComponent extends Component {
	render() {
		return (
			<React.Fragment>
				<DemoCard code={HorizontalMd}>
					<Horizontal />
				</DemoCard>
				<DemoCard code={InlineMd}>
					<Inline />
				</DemoCard>
				<DemoCard code={InlineCollapsedMd}>
					<InlineCollapsed />
				</DemoCard>
				<DemoCard code={SideCurrentMd}>
					<SideCurrent />
				</DemoCard>
				<DemoCard code={VerticalMd}>
					<Vertical />
				</DemoCard>
				<DemoCard code={ThemeMd}>
					<Theme />
				</DemoCard>
				<DemoCard code={SwitchModeMd}>
					<SwitchMode />
				</DemoCard>
