	...
	return (
		<div>
			...
			<div className="mt-4">
				...
				<p>
					Go to <code>FirebaseConfig.js</code> located at directory <code>configs/</code> and enter the config value that able to acquire from your firebase account.
				</p>
			...
			<div className="mt-4">
				<h4>Setup</h4>
				<p>
					You can set your own authentication provider at <code>auth/FirebaseAuth.js</code>. The following code is the default for Firebase.
				</p>
				<SyntaxHighlighter className="hl-code" language="javascript" style={atomDark}>
					{fbSetupStr}
				</SyntaxHighlighter>
