...
const SideContent = (props) => {
	...
	return (
		<div style={{ width: `${sideContentWidth}px`, borderInlineEnd: `1px solid ${currentTheme === 'dark' ? DARK_MODE.BORDER_BASE_COLOR : BORDER.BASE_COLOR}` }}>{sideContent}</div>
	);
};
...
const SideContentMobile = (props) => {
	...
	return (
		<Drawer width={320} placement="left" closable={false} onClose={onSideContentClose} open={visible} bodyStyle={{ paddingLeft: 0, paddingRight: 0 }}>
...
export const InnerAppLayout = (props) => {
	...
	return (
		<Card
			...
			`}
		>
			{isMobile ? <SideContentMobile visible={visible} onSideContentClose={close} {...props} /> : <SideContent {...props} />}
