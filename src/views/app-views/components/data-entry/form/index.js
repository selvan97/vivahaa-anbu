	...
	return (
		...
		>
			...
			<div className="form-method">
				<DemoCard code={ControlHooksMd}>
					<ControlHooks />
				</DemoCard>
			</div>
			<div className="form-method">
				<DemoCard code={ControlRefMd}>
					<ControlRef />
				</DemoCard>
			</div>
			<div className="layout">
				<DemoCard code={LayoutMd}>
					<Layout />
				</DemoCard>
			</div>
			...
			<div className="dynamic-form-item">
				<DemoCard code={DynamicFormItemMd}>
					<DynamicFormItem />
				</DemoCard>
			</div>
			<div className="nest">
				<DemoCard code={NestMessagesMd}>
					<NestMessages />
				</DemoCard>
			</div>
			<div className="complex-form-control">
				<DemoCard code={ComplexFormControlMd}>
					<ComplexFormControl />
				</DemoCard>
			</div>
			...
			<div className="normal-login">
				<DemoCard code={NormalLoginMd}>
					<NormalLogin />
				</DemoCard>
			</div>
			<div className="registration">
				<DemoCard code={RegisterMd}>
					<Register />
				</DemoCard>
			</div>
			<div className="advanced-search">
				<DemoCard code={AdvancedSearchMd}>
					<AdvancedSearch />
				</DemoCard>
			</div>
			<div className="dynamic-form-item">
				<DemoCard code={FormInModalMd}>
					<FormInModal />
				</DemoCard>
			</div>
			<div className="time-related-controls">
				<DemoCard code={TimeRelatedControlsMd}>
					<TimeRelatedControls />
				</DemoCard>
			</div>
			<div className="handle-form-data-manually">
				<DemoCard code={WithoutFormCreateMd}>
					<WithoutFormCreate />
				</DemoCard>
			</div>
			<div className="validate-static">
				<DemoCard code={ValidateStaticMd}>
					<ValidateStatic />
				</DemoCard>
			</div>
			<div className="dynamic-rule">
				<DemoCard code={DynamicRuleMd}>
					<DynamicRule />
				</DemoCard>
			</div>
			<div className="other-form">
				<DemoCard code={ValidateOtherMd}>
					<ValidateOther />
				</DemoCard>
			</div>
