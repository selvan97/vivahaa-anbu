		...
		<div>
			...
			<div className="mt-4">
				<Alert
					...
					description={
						<span>
							Note: If you want to connect API with your dev server, please make sure you have remove the mock server injectionin <strong>App.js</strong>
						</span>
					}
					showIcon
				/>
			...
			<div className="mt-4">
				...
				<ol>
					<li>
						<p>
							First, create a <code>xxxService.js</code> file(depends on your feature or module) under <code>services</code> directory
						</p>
					</li>
					<li>
						<p>
							Declare an async function returning <code>ApiService.fetch</code> method and pass in your api configuration details as the code below:
						</p>
			...
			<div className="mt-5">
				<h4>Proxying</h4>
				<p>
					Developer often consume API from different servers than the frontend application, there are complications that arise as a result of requests being sent across both
					servers, here is some way to setting up a proxy server.
				</p>
				<ul>
					<li>
