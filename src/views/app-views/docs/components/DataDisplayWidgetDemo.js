...
const Demo = () => {
	return (
		<div className="d-flex align-items-center flex-column">
			<div style={{ width: 300 }}>
				<DataDisplayWidget icon={<BarChartOutlined />} value="$11,388" title="Revenue" color="blue" size={'md'} avatarSize={50} vertical={false} />
			</div>
			<div style={{ width: 300 }}>
				<DataDisplayWidget icon={<BarChartOutlined />} value="$37,212" title="Net Profit" color="cyan" size={'md'} avatarSize={50} vertical={true} />
			</div>
		</div>
	);
};
