...
const LineDemo = () => {
	...
	return <ChartWidget title="Unique Visitors" series={visitorChartData.series} xAxis={visitorChartData.categories} height={400} />;
};
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="https://apexcharts.com/docs/options/annotations/">Apexcharts option</a>
							</td>
							<td></td>
						</tr>
						<tr>
