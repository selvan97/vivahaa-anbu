	...
	render() {
		return (
			<>
				...
				<DemoCard code={SlideMd}>
					<Slide />
				</DemoCard>
				<DemoCard code={ExtraMd}>
					<Extra />
				</DemoCard>
				...
				<div
					...
					`}
				>
					<DemoCard code={CardTopMd}>
						<CardTop />
					</DemoCard>
				</div>
				<DemoCard code={CustomAddTriggerMd}>
					<CustomAddTrigger />
				</DemoCard>
				<DemoCard code={CustomTabBarMd}>
					<CustomTabBar />
				</DemoCard>
