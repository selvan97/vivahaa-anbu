...
export class SimpleMap extends Component {
	render() {
		return (
			<React.Fragment>
				<DemoCard code={BasicAnnotationMd}>
					<BasicAnnotation />
				</DemoCard>
				<DemoCard code={BasicMarkerMd}>
					<BasicMarker />
				</DemoCard>
				<DemoCard code={BasicWorldMapMd}>
					<BasicWorldMap />
				</DemoCard>
				<DemoCard code={CustomMarkerMd}>
					<CustomMarker />
				</DemoCard>
				<DemoCard code={EuropeMapWithGraticuleMd}>
					<EuropeMapWithGraticule />
				</DemoCard>
				<DemoCard code={GraticuleMd}>
					<Graticule />
				</DemoCard>
				<DemoCard code={MapChartWithTextureMd}>
					<MapChartWithTexture />
				</DemoCard>
				<DemoCard code={MapChartWithTooltipMd}>
					<MapChartWithTooltip />
				</DemoCard>
				<DemoCard code={ChoroplethMapQuantileMd}>
					<ChoroplethMapQuantile />
				</DemoCard>
				<DemoCard code={ChoroplethMapQuantizeMd}>
					<ChoroplethMapQuantize />
				</DemoCard>
				<DemoCard code={StateMapMd}>
					<StateMap />
				</DemoCard>
				<DemoCard code={ChoroplethMapMd}>
					<ChoroplethMap />
				</DemoCard>
				<DemoCard code={ZoomingAndPannningMd}>
					<ZoomingAndPannning />
				</DemoCard>
