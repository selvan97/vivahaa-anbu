	...
	render() {
		return (
			<React.Fragment>
				...
				<DemoCard code={BorderLessMd}>
					<BorderLess />
				</DemoCard>
				<DemoCard code={SimpleMd}>
					<Simple />
				</DemoCard>
				<DemoCard code={FlexibleContentMd}>
					<FlexibleContent />
				</DemoCard>
				<DemoCard code={InColumnMd}>
					<InColumn />
				</DemoCard>
				<DemoCard code={LoadingMd}>
					<Loading />
				</DemoCard>
				<DemoCard code={GridCardMd}>
					<GridCard />
				</DemoCard>
				<DemoCard code={InnerMd}>
					<Inner />
				</DemoCard>
				<DemoCard code={TabsMd}>
					<Tabs />
				</DemoCard>
				<DemoCard code={MetaMd}>
					<Meta />
				</DemoCard>
