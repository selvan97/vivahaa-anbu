...
export class ResultComponent extends Component {
	render() {
		return (
			<React.Fragment>
				<DemoCard code={SuccessMd}>
					<Success />
				</DemoCard>
				<DemoCard code={InfoMd}>
					<Info />
				</DemoCard>
				<DemoCard code={WarningMd}>
					<Warning />
				</DemoCard>
				<DemoCard code={Result403Md}>
					<Result403 />
				</DemoCard>
				<DemoCard code={Result404Md}>
					<Result404 />
				</DemoCard>
				<DemoCard code={Result500Md}>
					<Result500 />
				</DemoCard>
				<DemoCard code={ErrorMd}>
					<Error />
				</DemoCard>
				<DemoCard code={CustomIconMd}>
					<CustomIcon />
				</DemoCard>
