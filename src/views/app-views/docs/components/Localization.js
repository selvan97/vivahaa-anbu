...
const Localization = () => {
	return (
		<div>
			<h2>Localization</h2>
			<p>
				Emilus implement localization through <code>react-i18n-next</code>, corresponding files can be found in <code>src/lang/</code>, folder structure as below
			</p>
			<div className="mb-4">
			...
			<div className="mt-5">
				...
				<p>
					<code>locales</code> folder is the place we store language key. Add your language as JSON format in this folder.
				</p>
				<SyntaxHighlighter className="hl-code" language="json" style={atomDark}>
					{langKey}
				</SyntaxHighlighter>
				<p className="mt-3">
					Create a config file for your new added language at <code>entries</code> folder, please also include antd language to the configuration.
				</p>
				<SyntaxHighlighter className="hl-code" language="javascript" style={atomDark}>
					{langConfig}
				</SyntaxHighlighter>
				<p className="mt-3">
					Add your configuration to the <code>index.js</code>, which is the entry file of i18n. Setup a key with your language config as value in <code>resources</code>.
				</p>
				<SyntaxHighlighter className="hl-code" language="javascript" style={atomDark}>
					{langEntry}
				</SyntaxHighlighter>
				<p className="mt-3">
					Now, with <code>IntlMessage</code> component, you can translate your language with your language key
				</p>
