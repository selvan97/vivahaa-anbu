	...
	render() {
		return (
			<React.Fragment>
				...
				<DemoCard code={SmallSizeMd}>
					<SmallSize />
				</DemoCard>
				<DemoCard code={IconMd}>
					<Icon />
				</DemoCard>
				<DemoCard code={StepNextMd}>
					<StepNext />
				</DemoCard>
				<DemoCard code={VerticalMd}>
					<Vertical />
				</DemoCard>
				<DemoCard code={VerticalSmallMd}>
					<VerticalSmall />
				</DemoCard>
				<DemoCard code={ErrorMd}>
					<Error />
				</DemoCard>
				<DemoCard code={ProgressDotMd}>
					<ProgressDot />
				</DemoCard>
				<DemoCard code={CustomizedProgressDotMd}>
					<CustomizedProgressDot />
				</DemoCard>
				<DemoCard code={ClickableMd}>
					<Clickable />
				</DemoCard>
				<DemoCard code={NavMd}>
					<Nav />
