...
const logData = [
	...
	},
	{
		version: '4.0.0',
		date: '20 Mar 2023',
		updateContent: ['[Update] Antd to v5.3.0', '[New] Add antd theme configuration', '[Breaking Change] Remove most less style'],
	},
	{
		version: '3.0.0',
		date: '1 Nov 2022',
	...
	},
	{
		version: '2.1.6',
		date: '2 Apr 2022',
		updateContent: ['[Fix] Scrumboard rename error', '[Fix] Scrumboard dropdown gutter issue', '[Fix] Object referencing issus in ChartWidget'],
	},
	{
		version: '2.1.5',
		date: '15 Dec 2021',
	...
	},
	{
		version: '2.1.4',
		date: '16 Sep 2021',
		updateContent: ['[Fix] Minor ui issues', '[Fix] ultility spacer not working on responsive', '[New] Added Figma design prototype (lite)'],
	},
	{
		version: '2.1.3',
		date: '3 Sep 2021',
	...
	},
	{
		version: '2.1.2',
		date: '26 May 2021',
		updateContent: ['[Fix] Date range picker selected color in dark mode', '[Fix] Dashboard Apex chart out of border'],
	},
	{
		version: '2.1.1',
		date: '28 Apr 2021',
		updateContent: ['[Fix] User list responsive issue', '[Fix] Typo in NavProfile', '[Update] Antd to v4.15.3'],
	},
	{
		version: '2.1.0',
		date: '21 Mar 2021',
	...
	},
	{
		version: '2.0.0',
		date: '7 Jan 2021',
		updateContent: ['[New] Dark mode', '[Update] Dependencies Update', '[Breaking Change] Switch scss to less'],
	},
	{
		version: '1.1.3',
		date: '12 Nov 2020',
	...
	},
	{
		version: '1.1.2',
		date: '24 Oct 2020',
		updateContent: ['[Fix] Page rerender when side nav toggle clicked', '[Add] Delete & Rename Board to Scrumboard', '[Add] App prefix path as constant'],
	},
	{
		version: '1.1.1',
		date: '28 Sep 2020',
