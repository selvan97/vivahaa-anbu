...
const Demo = () => {
	...
	return (
		<>
			<div className="mb-3">
				<AvatarStatus src="https://zos.alipayobjects.com/rmsportal/ODTLcjxAfvqbxHnVXCYX.png" name="Terrance Moreno" subTitle="Software Engineer" />
			</div>
			<div className="mb-3">
				<AvatarStatus icon={<FolderOutlined />} name="Terrance Moreno" type="cyan" subTitle="Software Engineer" />
			</div>
			<div className="mb-3">
				<AvatarStatus text="TM" type="blue" name="Terrance Moreno" subTitle="Software Engineer" />
			</div>
			<div className="mb-3">
				<AvatarStatus
					src="http://enlink.themenate.net/assets/images/avatars/thumb-3.jpg"
