			...
			<React.Fragment>
				<Row gutter={16} type="flex">
					<Col sm={24} md={24} lg={12}>
						<DemoCard code={LineChartMd}>
							<LineChart />
						</DemoCard>
						<DemoCard code={BarChartMd}>
							<BarChart />
						</DemoCard>
						<DemoCard code={DoughnutChartMd}>
							<DoughnutChart />
						</DemoCard>
					</Col>
					<Col sm={24} md={24} lg={12}>
						<DemoCard code={AreaChartMd}>
							<AreaChart />
						</DemoCard>
						<DemoCard code={RadarChartMd}>
							<RadarChart />
						</DemoCard>
						<DemoCard code={PolarChartMd}>
							<PolarChart />
						</DemoCard>
					</Col>
				</Row>
