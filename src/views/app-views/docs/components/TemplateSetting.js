...
export const APP_NAME = 'Vivahaa Matrimony';
...
const themeConfig = `export const baseTheme = {
    ...
    controlHeightLG: 48,
    controlHeightSM: 36,
    fontFamily: 'Mulish', -apple-system, BlinkMacSystemFont, Segoe UI, Mulish, 'Helvetica Neue', Arial,
...
const TemplateSetting = () => {
  return (
    <div>
      ...
      <p>
        Vivahaa Matrimony comes with a variety of different theme & layout, you
        can try them from quick view panel in our demo and copy the config to
        your project.
      </p>
      <div className="mt-4">
